...
public interface ProposalRepository extends CrudRepository<Proposal, String>, PagingAndSortingRepository<Proposal, String> {
  ...
  List<Proposal> findByIdContaining(@Param("text") String text);
}
